...
def load_config(mode=None):
    ...
    parser.add_argument('--path', '--checkpoints', type=str, default='/ckpt_zhuyilic',
    ...
    parser.add_argument('--config_file', type=str, default=os.path.join(os.getcwd(), 'Guided_Upsample\config_list', 'config_template.yml'),
    ...
    # test mode
    if mode == 2:
        parser.add_argument('--input', type=str, default=r'F:\paper1\flist\test.flist',
                            help='path to the input images directory or an input image')
        parser.add_argument('--mask', type=str, default='F:\paper1\mask\test.flist',
                            help='path to the masks directory or a mask file')


        parser.add_argument('--prior', type=str, default='/Guided_Upsample/testimage/structure',
